...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      print('DEBUG: SignIn - Demo mode authentication');
      print('DEBUG: SignIn - Email: ${_emailController.text.trim()}');

      // Simulate authentication delay
      await Future.delayed(const Duration(seconds: 1));

      print('DEBUG: SignIn - User authenticated successfully in demo mode');
