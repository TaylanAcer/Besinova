...
class _ShoppingListScreenState extends State<ShoppingListScreen> {
  ...
  Product _shoppingItemToProduct(ShoppingItem item) {
    return Product(
      ...
      subcategory: item
          .category, // Use category as subcategory since ShoppingItem doesn't have subcategory
      price: item.price,
                                ...
                                children: [
                                  ...
                                  Consumer<UserProvider>(
                                    builder: (context, userProvider, child) {
                                      ...
                                      if (user != null) {
                                        return Text(
                                          '${user.budget.toStringAsFixed(0)} ₺ bütçe',
                                          style: TextStyle(
                                            color: Colors.white
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      item.market.isNotEmpty
                          ? item.market
                          : 'Market bilgisi yok',
                      style: TextStyle(
                        color: Colors.white.withValues(alpha: 0.6),
                        fontSize: 12,
                        fontStyle: item.market.isEmpty
                            ? FontStyle.italic
                            : FontStyle.normal,
                      ),
                      maxLines: 1,
