...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    super.initState();
    // The UserProvider now handles data loading automatically
    // No need to manually load user data
    print(
        'DEBUG: SettingsScreen - UserProvider user loaded, budget: ${Provider.of<UserProvider>(context, listen: false).budget}');
  }
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              // Update user data using the new UserProvider methods
  ...
  Widget _buildBudgetSetting() {
    ...
    print(
        'DEBUG: SettingsScreen._buildBudgetSetting - currentBudget: $currentBudget');
    print(
        'DEBUG: SettingsScreen._buildBudgetSetting - userProvider.budget: ${userProvider.budget}');
    print(
        'DEBUG: SettingsScreen._buildBudgetSetting - hasSetBudget: $hasSetBudget');
        ...
        builder: (context, setState) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                print(
                    'DEBUG: Budget dialog save button pressed with selectedBudget: $selectedBudget');
                ...
                if (mounted) {
                  print(
                      'DEBUG: SettingsScreen setState() called to rebuild UI');
                  setState(() {});
                }
