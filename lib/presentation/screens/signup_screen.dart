...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      print('DEBUG: SignUp - Demo mode registration');
      print('DEBUG: SignUp - Name: ${_nameController.text}');
      print('DEBUG: SignUp - Email: ${_emailController.text.trim()}');

      // Simulate registration delay
      await Future.delayed(const Duration(seconds: 1));

      print('DEBUG: SignUp - User registered successfully in demo mode');

      // Create user data in UserProvider
      final userProvider = Provider.of<UserProvider>(context, listen: false);
      await userProvider.createUserForDemoUser(
