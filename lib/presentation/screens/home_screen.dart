...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _showOnboardingIfFirstTime() async {
    // Check if onboarding has been shown before using persistent storage
    final onboardingShown = StorageService.getUserField<bool>(AppConstants.storageKeyOnboardingShown) ?? false;
          ...
          actions: [
            TextButton(
              onPressed: () {
                ...
                // Mark onboarding as shown in persistent storage
                StorageService.saveUserField(AppConstants.storageKeyOnboardingShown, true);
              },
